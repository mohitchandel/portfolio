  ...
  return (
    ...
    >
      <Image
        src={image}
        alt={name}
        className={`absolute -bottom-2 w-[70%] rounded-lg sm:w-[85%] md:w-[60%] lg:max-w-[55%] ${
      ...
      >
        <AnimatedTitle
          text={name}
          className={
            "max-w-[90%] text-[20px] leading-none text-white md:text-[24px] md:leading-none lg:max-w-[450px] lg:text-[28px] lg:leading-none"
          }
          wordSpace={"mr-[0.25em]"}
          charSpace={"-mr-[0.01em]"}
        />
        ...
        <div className="mt-9 flex gap-4">
          {technologies.map((tech, id) => (
            <AnimatedTitle
              ...
              key={id}
              className={
                "text-[14px] font-bold uppercase md:text-[16px] lg:text-[12px] "
              }
            />
          ))}
        </div>
